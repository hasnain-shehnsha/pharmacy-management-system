        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <form action="{{ route('suppliers.show') }}" method="POST" style="display:inline;">
                            @csrf
                        ...
                        <form action="{{ route('suppliers.destroy') }}" method="POST" style="display:inline;">
                            @csrf
                            <input type="hidden" name="id" value="{{ $supplier->id }}">
                ...
                @empty
                <tr><td colspan="5" style="text-align:center;">No supplier found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
