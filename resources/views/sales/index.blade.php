...
<div class="container">
        ...
        @endif
        <a href="{{ route('sales.create') }}" class="btn">Add New Sale</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <form action="{{ route('sales.show') }}" method="POST" style="display:inline;">
                            @csrf
                ...
                @empty
                <tr><td colspan="5" style="text-align:center;">No sale found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
