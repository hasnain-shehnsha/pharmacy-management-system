        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <form action="{{ route('customers.show') }}" method="POST" style="display:inline;">
                            @csrf
                            <input type="hidden" name="id" value="{{ $customer->id }}">
                            <button type="submit" class="btn show-btn">Show</button>
                        </form>
                        <form action="{{ route('customers.edit') }}" method="POST" style="display:inline;">
                            @csrf
                            <input type="hidden" name="id" value="{{ $customer->id }}">
                            <button type="submit" class="btn" style="background:#f59e42; color:#fff;">Edit</button>
                        </form>
                        <form action="{{ route('customers.destroy') }}" method="POST" style="display:inline;">
                            @csrf
                            <input type="hidden" name="id" value="{{ $customer->id }}">
                ...
                @empty
                <tr><td colspan="4" style="text-align:center;">No customer found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
