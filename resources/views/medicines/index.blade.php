...
<div class="container">
    ...
    @endif
    <a href="{{ route('medicines.create') }}" class="btn">Add New Medicine</a>
    <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <form action="{{ route('medicines.show') }}" method="POST" style="display:inline;">
                        @csrf
                    ...
                    @if(Auth::user()->role === 'admin')
                        ...
                        <form action="{{ route('medicines.destroy') }}" method="POST" style="display:inline;">
                            @csrf
                            <input type="hidden" name="id" value="{{ $medicine->id }}">
            ...
            @empty
            <tr><td colspan="6" style="text-align:center;">No medicine found.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
