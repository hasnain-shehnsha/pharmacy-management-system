...
<div class="header">
    ...
    <div class="container">
        ...
        <form action="{{ route('medicines.update') }}" method="POST">
            ...
            <input type="text" name="company_name" value="{{ $medicine->company_name }}" required>
            <label>Batch No *</label>
            <input type="text" name="batch_no" value="{{ $medicine->batch_no }}" required>
            <label>Quantity *</label>
            <input type="number" name="quantity" value="{{ $medicine->quantity }}" min="0" required>
            <label>Price *</label>
            <input type="number" name="price" value="{{ $medicine->price }}" min="0" required>
